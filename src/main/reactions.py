...
def get_legacy_reactions():
    legacy_reactions = dict()
    with open('../resources/legacy/reaction.txt', "rb") as fp:
        legacy_reactions.update(pickle.load(fp))
    return legacy_reactions
